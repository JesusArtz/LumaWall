...
xcrun swiftc -sdk "$SDK_PATH" -target "$ARCH-apple-macosx14.0" -framework CoreGraphics -framework ImageIO \
  "$PROJECT_DIR/Sources/Models.swift" "$PROJECT_DIR/Sources/ScenePackage.swift" "$PROJECT_DIR/Sources/WallpaperImporter.swift" \
